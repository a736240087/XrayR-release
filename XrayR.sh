...
#        return 0
#    fi
    bash <(curl -Ls https://raw.githubusercontent.com/a736240087/XrayR-release/main/install.sh) $version
    if [[ $? == 0 ]]; then
...
update_shell() {
    wget -O /usr/bin/XrayR -N --no-check-certificate https://raw.githubusercontent.com/a736240087/XrayR-release/main/XrayR.sh
    if [[ $? != 0 ]]; then
        echo ""
...
--- https://github.com/a736240087/XrayR ---
  ${green}0.${plain} 修改配置
————————————————
